...
namespace ConsoleApp1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //3
            //string sentense = "Hello man, lol kek 4ebyrek?";
            ...
            Console.WriteLine();
            //Console.WriteLine((int)min_index_i + (int)min_index_j);
            Console.Write((int)min_index_i + " ");
            Console.Write((int)min_index_j);
            Console.WriteLine();
            //Console.WriteLine((int)max_index_i + (int)max_index_j);
            Console.Write((int)max_index_i + " ");
            Console.Write((int)max_index_j);
